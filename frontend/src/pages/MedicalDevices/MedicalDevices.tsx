...
import MedicalDeviceSearch from "../../components/medicalDevice/MedicalDeviceSearch";
import MedicalDeviceTable from "../../components/medicalDevice/MedicalDeviceTable";
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p
              ...
              style={{ fontFamily: "Roboto Slab" }}
            >
              Explore medical devices and diagnostic tests
              related to MASLD and associated diseases.
            </p>
          </div>
        </div>
      </div>
        ...
        >
          ...
          <div className="mb-4">
            <p className="text-sm font-medium text-slate-700">
              ...
              of {totalRecords.toLocaleString()} medical devices
            </p>
          </div>
